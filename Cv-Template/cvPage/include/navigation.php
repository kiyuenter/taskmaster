        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="../../pages/experts.php">Experts</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dr">
                  <li><a class="dropdown-item text-dark" href="../../pages/askQuestion.php">Ask Question</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="../../pages/contactUs.php">Contact Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="../../pages/aboutUs.php">About Us</a>
              </li>
            </ul>
                <?php
