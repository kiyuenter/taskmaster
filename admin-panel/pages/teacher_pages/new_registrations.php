        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <ul id="usermanagement" class="sidebar-dropdown list-unstyled collapse ms-4" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed has-dropdown ms-2 some" data-bs-toggle="collapse"
                            data-bs-target="#teacheraccount" aria-expanded="false"
                            aria-controls="teacheraccount">Teacher Account</a>
                        <ul id="teacheraccount" class="ms-4 sidebar-dropdown list-unstyled collapse"
                            data-bs-parent="#usermanagement">
                            <li class="sidebar-item some">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="evaluation" class="sidebar-dropdown list-unstyled collapse ms-4"
                        data-bs-parent="#evaluation">
                        <li class="sidebar-item">
                            <a href="../evaluations_pages/questions.php" class="sidebar-link ms-2">Evaluation
                                Questions</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="../evaluations_pages/teachers_answers.php" class="sidebar-link ms-2">Teachers
                                Answer</a>
                        </li>
                    </ul>
                    </a>
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    <div class="mb-3">
                        ...
                        <div class="bg-dark rounded m-5 align-items-center justify-content-start d-flex" style="height: 50px;">
                            <a href="../../sendResult.php" class="btn btn-primary">Send Message</a>
                        </div>
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <div class="card" style="width: 24rem;">
                                                    <div class="d-flex justify-content-center align-items-center m-4">
                                                        <img style="border-radius: 50%; width: 150px; object-fit: contain;" src="../../../teacherfiles/' . $row["profilePicture"] . '" class="card-img-top" alt="profile">
                                                    </div>
                                                    <div class="card-body">
                                        ...
                                        if ($row["academic"] == "Ph.D" || $row["academic"] == "Ed.D" || $row["academic"] == "M.D" || $row["academic"] == "MA" || $row["academic"] == "MSc" || $row["academic"] == "MFA") {
                                            echo '
                                                <div class="d-flex justify-content-between mt-2 align-items-center">
                                                    <p class="card-text">Paper</p>
                                                    <p><a id="download-link" href="../../../teacher-Evaluation-Doc/' . $row["paper"] . '" data-file-path="" class="btn btn-success m-2">Download</a></p>
                                                </div>
                                            ';
                                        } else {
                                            echo '
                                             <div class="d-flex justify-content-between mt-2 align-items-center">
                                                <p class="card-text">Exam Grade : </p>
                                                <p class="text-center">' . $row["paper"] . '</p>
                                            </div>
                                            ';
                                        }
