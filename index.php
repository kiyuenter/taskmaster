...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="pages/experts.html">Experts</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dr">
                  <li><a class="dropdown-item text-dark" href="pages/askQuestion.html">Ask Question</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="pages/contactUs.html">Contact Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-light text-dark me-4 text-center w-100" href="pages/aboutUs.html">About Us</a>
              </li>
            </ul>
    ...
    <div class="container-fluid div-1">
      <div class="row div-1 banner align-items-center justify-content-center">
        ...
        <div class="col-md-6">
          <h1 class="text-primary text-md-right">Welcome to <br><img src="photo/Task.png" alt="Task Logo" style="max-width: 50px;" class="img-fluid"> askmaster Assignment Helper and CV Maker</h1>
          <p>Rest assured, we specialize in connecting you with top-tier assignment experts, ensuring unparalleled quality every step of the way.</p>
  ...
  <!-- Promotion content startup -->
      ...
      <div class="front-content row">
        ...
        <div class="paragraph col-md-6 w-50 mt-5">
          <div class="mt-5 d-flex justify-content-center align-items-center">
            <p class="text-center"><span class="text-success">Taskmaster:</span> <span>Empowering Your Academic Journey</span></p>
          </div>
          <div class="definition">
            <p>Taskmaster empowers you to take control of your academic journey. Our platform provides tools and resources to manage your workload, prioritize tasks, and meet deadlines effectively.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="container-1 container-fluid d-flex justify-content-center align-items-center div-promotion py-5">
      <div class="front-content row">
        <div class="paragraph col-md-6 w-50 mt-5">
          <div class="mt-5 d-flex justify-content-center align-items-center">
            <p class="text-center"><span class="text-success">CV Maker:</span> <span> Craft a Compelling Resume That Gets Noticed!</span></p>
          </div>
          <div class="definition">
            <p>Taskmaster goes beyond just assignment help. We offer personalized support and guidance to help you develop strong study habits, improve your research skills, and gain a deeper understanding of course material.</p>
          </div>
        </div>
        <div class="img-1 col-md-6 w-50 d-flex justify-content-center">
    ...
    <div class="container-1 container-fluid d-flex justify-content-center align-items-center div-promotion-2 py-5">
      <div class="front-content row">
        ...
        <div class="paragraph col-md-6 w-50 mt-5">
          <div class="mt-5 d-flex justify-content-center align-items-center">
            <p class="text-center"><span class="text-success">Taskmaster:</span> <span>Boost Your Confidence and Ace Your Assignments!</span></p>
          </div>
          <div class="definition">
            <p>Taskmaster provides comprehensive resources and personalized feedback to help you grasp complex concepts and gain a deeper understanding of your coursework.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="container-1 container-fluid d-flex justify-content-center align-items-center">
      <div class="front-content row">
        <div class="paragraph col-md-6 w-50 mt-5">
          <div class="mt-5 d-flex justify-content-center align-items-center">
              <p class="text-center"><span class="text-success">CV Maker:</span> <span> Showcase Your Skills and Land Your Dream Job</span></p>
          </div>
          <div class="definition">
              <p>Our CV Maker guides you through highlighting your skills and experience in a way that grabs attention and showcases your value to potential employers.</p>
          </div>
        </div>
          ...
          <div class="carousel-item testimonial-img active w-100">
            <div class="d-flex justify-content-center align-items-center w-100">
              <div class="m-5 py-5 px-3 bg-test">
                ...
                <p>TaskMaster Assignment Helper and CV Maker has been an absolute lifesaver for me. As a busy professional juggling multiple responsibilities, I often found myself overwhelmed with tasks and deadlines, especially when it came to crafting compelling resumes and cover letters. However, since discovering TaskMaster, those worries have become a thing of the past.</p>
              </div>
              <div class="m-5 py-5 px-3 bg-test">
                <div class="d-flex align-items-center justify-content-center">
                ...
                <p>Their assignment help service is unparalleled in quality and reliability. Whether it's a challenging essay, a complex research paper, or a daunting presentation, TaskMaster's team of experts consistently delivers outstanding results within my specified timeframe. Their attention to detail and commitment to excellence truly set them apart.</p>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item testimonial-img active w-100">
            <div class="d-flex justify-content-center align-items-center w-100">
              <div class="m-5 py-5 px-3 bg-test">
                ...
                <p>Moreover, their CV Maker feature is a game-changer. Crafting a standout resume has never been easier thanks to their intuitive platform, which guides you through the process step-by-step. From formatting to content optimization, TaskMaster ensures that your resume showcases your skills and experiences in the best possible light, helping you stand out in today's competitive job market.</p>
              </div>
              <div class="m-5 py-5 px-3 bg-test">
                <div class="d-flex align-items-center justify-content-center">
                ...
                <p>Overall, I can't recommend TaskMaster Assignment Helper and CV Maker highly enough. Their professionalism, expertise, and dedication to customer satisfaction make them an invaluable resource for anyone seeking academic or professional assistance. Thank you, TaskMaster, for making my life easier and helping me achieve my goals!</p>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item testimonial-img active w-100">
            <div class="d-flex justify-content-center align-items-center w-100">
              <div class="m-5 py-5 px-3 bg-test">
                ...
                <p>TaskMaster Assignment Helper and CV Maker is a true lifesaver! As a student striving for academic excellence while also navigating the complexities of job hunting, I was in desperate need of a reliable solution to help me manage my workload and enhance my professional profile. TaskMaster proved to be the perfect solution.</p>
              </div>
              <div class="m-5 py-5 px-3 bg-test">
                <div class="d-flex align-items-center justify-content-center">
                ...
                <p>Their assignment help service is a godsend. With a team of skilled experts covering a wide range of subjects and topics, TaskMaster consistently delivers top-notch academic work that exceeds expectations. From essays to dissertations, they tackle each task with precision and expertise, ensuring that I always receive high grades and positive feedback from my professors.</p>
              </div>
            </div>
          </div>
      </div>
