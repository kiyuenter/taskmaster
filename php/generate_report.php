...
if ($type == "pdf") {
    ...
    if ($reportType == "regStud") {
        ...
        $conn->close();
        $pdf->Output('Student_Registration.pdf', 'D');
        ...
        class PDF extends FPDF {
            ...
            function Header() {
                $this->SetFont('Arial', 'B', 12);
                $this->Cell(0, 10, ' All in one Report', 0, 1, 'C');
                $this->Cell(0, 10, ' Student Registration', 0, 1, 'C');
            }
